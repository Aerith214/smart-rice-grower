...
const AdminAuth = () => {
  ...
  useSEO({
    ...
    description: "Administrator authentication for SmartRice management system.",
    canonicalPath: "/admin-auth",
  });
      ...
      <div className="max-w-md mx-auto">
        <header className="mb-8 text-center">
          ...
          <p className="text-muted-foreground">
            Access the administrative panel to manage system data and settings.
          </p>
        </header>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Sign in to the admin panel or create a new administrator account.
            </CardDescription>
          </CardHeader>
          <CardContent>
